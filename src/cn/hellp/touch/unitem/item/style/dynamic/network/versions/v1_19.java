...
public class v1_19 implements VersionSupport {
    @Override
    ...
    public Object getNetworkManager(Object playerConnection) {
        return ChannelInjector.getField(ChannelInjector.playerConnectionClass,playerConnection,"b");
    }

    @Override
    public Channel getChannel(Object networkManager) {
        return (Channel) ChannelInjector.getField(ChannelInjector.networkManagerClass,networkManager,"m");
    }
